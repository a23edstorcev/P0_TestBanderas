...
function createQuestion($question, $answer_1, $answer_2, $answer_3, $answer_4, $correct_answer) {
    global $conn;
    
    $stmt = $conn->prepare("INSERT INTO preguntas (question, answer_1, answer_2, answer_3, answer_4, correct_answer) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssi", $question, $answer_1, $answer_2, $answer_3, $answer_4, $correct_answer);
...
function updateQuestion($id, $question, $answer_1, $answer_2, $answer_3, $answer_4, $correct_answer) {
    global $conn;
    
    $stmt = $conn->prepare("UPDATE preguntas SET question = ?, answer_1 = ?, answer_2 = ?, answer_3 = ?, answer_4 = ?, correct_answer = ? WHERE id = ?");
    $stmt->bind_param("sssssii", $question, $answer_1, $answer_2, $answer_3, $answer_4, $correct_answer, $id);
